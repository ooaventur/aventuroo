...
# -*- coding: utf-8 -*-
"""
AventurOO – Autopost (Travel)
- Lexon vetem rreshtat "Travel|<RSS>" nga autopost/data/feeds.txt
...
SEEN_DB = ROOT / "autopost" / "seen_travel.json"
...
def main():
    ...
    for raw in FEEDS.read_text(encoding="utf-8").splitlines():
        ...
        if category != "Travel" or not feed_url:
            continue
